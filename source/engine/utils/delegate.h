...
// Edit from https://simoncoenen.com/blog/programming/CPP_Delegates
// We also have eventpp library as another choice.
namespace engine
{
	...
	private:
		...
		// Unvalid id.
		constexpr static const HandleType kInvalidID = HandleType(~0); // uint64_t(~0) 为全F最大值
